      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link href="mailto:subinanand8078@gmail.com" className={activeLink === 'contact' ? 'active navbar-link' : 'navbar-link'}  onClick={()=> console.log('connect')} >Contact</Nav.Link>
          </Nav> 
